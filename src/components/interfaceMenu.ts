...
interface Menu {
  ...
  readonly bottomElement?: boolean; // Pour mettre les éléments du menu (celui ci et les suivants) en bas du menu
  ...
  readonly sousMenu?: SousMenu[]; // sous-menu, interface juste au dessus
}
